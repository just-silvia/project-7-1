...
const Calculator = () => {
    ...
    const [changedLiters, setChangedLiters] = useState('');
    ...
    const [protocol, setProtocol] = useState('easylife');
    const [ghSalts, setGhSalts] = useState('masterline');
    const [khSalts, setKhSalts] = useState('drak');
    ...
    const saveResults = async () => {
        ...
        try {
            ...
            const response = await post("/save-calculation", dataToSave, "API");
                ...
                <div className="w-full lg:w-[60%] p-6 rounded-lg flex flex-wrap justify-between items-start mb-6 shadow-md bg-white dark:bg-gray-800">
                    <div className="calculator flex flex-col md:flex-row items-baseline gap-5 w-full">
                        ...
                        <div className="flex-1">
                            ...
                            <CustomButton onClick={calculateDosages} type="default">
