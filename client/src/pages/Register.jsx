        ...
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
            <div className="flex items-center justify-center bg-light dark:bg-dark px-4 py-10 sm:px-6 lg:px-8">
                <form onSubmit={handleSubmit} className="w-full max-w-md space-y-6">
                    ...
                    <div>
                        <label className="block font-medium mb-1 text-dark dark:text-gray-200">
                            First Name
                        ...
                        <input
                            ...
                            required
                            className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent dark:bg-gray-700 dark:text-white"
                        />
                    </div>
                    <div>
                        <label className="block font-medium mb-1 text-dark dark:text-gray-200">
                    ...
                    <div>
                        ...
                        <RevealValidatePassword
                            ...
                            required
                            inputClassName="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent dark:bg-gray-700 dark:text-white"
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-4">
                        <p className="text-sm text-dark dark:text-gray-200">
                            Have an account? <Link to="/login" className="text-accent dark:text-accent hover:text-primary dark:hover:text-gray-300 transition-colors">Login</Link>
                        </p>
                        <CustomButton
            ...
            <div className="hidden md:flex h-screen items-center justify-center bg-gray-100 dark:bg-gray-800">
                <img
                    src={img_register}
