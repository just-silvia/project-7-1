    ...
    <nav className="w-full z-10 fixed border-b py-4 bg-white dark:bg-dark">
      <div className="w-full px-5 mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <div className="h-12">
            <img src={logo} alt="Logo Aquatic Paradise" className="h-full object-contain" />
          </div>
          <div>
            {/* Titolo del sito */}
        ...
        <div className="md:hidden flex items-center">
          ...
          >
            {darkMode ? (
              ...
              <svg
                className="w-5 h-5 text-dark dark:text-gray-200"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link
            to="/"
            className="text-dark hover:text-accent transition-colors dark:text-gray-200 dark:hover:text-accent"
          >
            Home
          </Link>
          <Link
